...
public class MainActivity extends AppCompatActivity {
	private static final String AUTH_KEY = "key=AIzaSyDABIiP2mheALwOnDd3FAFlH9Vvfx-Aido";
		...
		try {
			...
			switch(type) {
				case "tokens":
					...
					ja.put("fRl8MmtcsOQ:APA91bHJErfgVmHHYIo0X9QIT50WjJHCv_w9CfyrMYNFbgumOs-FkxucosGAP6bDRPQ716F5mqOXtqK2FQr_FU0wAt87V7WSYn35YZnnoDGMZqk35x9a1gtGEa2c6ZVkY9EXJ3ZZisob");
